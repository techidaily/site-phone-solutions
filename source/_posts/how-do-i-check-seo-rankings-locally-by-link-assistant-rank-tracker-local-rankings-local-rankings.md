...
categories: 
  - seo tools
  - link-assistant
description: Here is how  go to your project's Preferences > Preferred Search Engines. There, for every new place, you can click the Add Custom button, and you'll be able to fill out your address precisely. From then on, you'll see your accurate local rankings for your target keywords for the exact location you need.
keywords: local seo,local seo tool,local seo rank tracking service,local seo software,local rankings,local seo rank tracking software,local seo rank tracking tool,local seo rank tracker,local seo rankings,local serp,local rank tracker,local seo rank tracking
---
