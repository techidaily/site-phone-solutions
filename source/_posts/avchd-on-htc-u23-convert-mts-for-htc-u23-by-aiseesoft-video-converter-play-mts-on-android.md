...
categories: 
  ...
  - aiseesoft
  - video converter
description: Trying to play AVCHD MTS video clips on your HTC U23 but failed? All you need is a useful AVCHD to HTC U23 converter. Check how to re-encode AVCHD .mts files to H.264 MP4 format for playing back on HTC U23 without any hassles. 
keywords: play mts clips on HTC U23,mts playback on HTC ,encode avchd to mp4 for HTC ,mts converter for U23,encode mts to mp4 for U23,watch avchd on U23,mts video converter for android,how to converter 720p to mts on android,best mts transcoder android,playing mts videos on phone android,mts converter for android,mts file not supported in HTC U23
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    What to do if your HTC U23 cannot play AVCHD .mts video clips? Depending on your device model, source media parameters, as well as the media player you are using, you may fail or have problems playing AVCHD MTS files on your HTC U23. In this article, we explain a solution to solve the issue. 
  </p>
</div>
</div>
...
<p>
  AVCHD (Advanced Video Coding High Definition) is a kind of compression format adopted by camcorders to record and store high definition videos with a resolution up to Full HD 1920*1080. The AVCHD footage usually includes .mts and .m2ts file extensions. If you encounter incompatibility issues while trying to play these AVCHD MTS files on HTC U23, you may follow the guide below to learn a way of converting AVCHD .mts/.m2ts clips to MP4 format for playing on HTC U23 without a glitch.
</p>
</div>
</div>

Part 1: <strong><a href="#p1">AVCHD MTS Conversion Suggestion For HTC U23 (on Windows)</a></strong>
Part 2: <strong><a href="#p2">AVCHD MTS Conversion Suggestion For HTC U23 (on macOS)</a></strong>

<!-- Part 1 -->
<a id="p1" name="p1" ></a><hr>

<div class="atpl-step-part-style">Part 1. AVCHD MTS Conversion Suggestion For HTC U23 (on Windows)</div>
To convert .mts video files for HTC U23 playback on Windows, do as below:
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/htc/fv.mp4/win/profile.png" class="atpl-imgstyle" alt="Select output profile format for HTC U23" />
...
<div class="atpl-step-part-style">Part 2. AVCHD MTS Conversion Suggestion For HTC U23 (on macOS)</div>
To convert .mts video files for HTC U23 playback on Mac, do as below:
