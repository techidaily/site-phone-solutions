...
keywords: convert avchd mts for Sony ,play avchd files on Sony Xperia 1 V,mts playback on Sony Xperia 1 V,play avchd files on Xperia 1 V,avchd player for Xperia 1 V,encode avchd to mp4 for Sony ,mts codec vlc android,Sony Xperia 1 V wont play mts,how to converter 720p to mts on android,mts converter for android,mts video converter for android,video to mts codec converter for android
---
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Cannot view AVCHD MTS files on your Sony Xperia 1 V flawlessly? The stock media player may refuse recognizing .mts file extension because Sony Xperia 1 V doesn’t have native support for AVCHD mts video clips. However, you could always use an app like Video Converter to convert your AVCHD .mts files to .mp4 format on your computer and then move them to your Sony Xperia 1 V for playback fluently without any incompatibility issues. In the guide below, we walk you through how to encode AVCHD MTS files to MP4 format for viewing on Sony Xperia 1 V smoothly.
  </p>
</div>
</div>
