---
title: Can you watch MOV movies on Redmi 12 ?
date: 2024-04-07T02:22:06.693Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: Will Xiaomi Redmi 12 support .mov files? If you are having issues playing MOV files on Xiaomi Redmi 12, you are just here in the right place. This article explains how to get Xiaomi Redmi 12 playing MOV movies in simple steps.
keywords: does mov play on Xiaomi,mov to Xiaomi converter,mov to Xiaomi Redmi 12 converter,play .mov on Xiaomi,Xiaomi Redmi 12 mov support,can't play .mov on Redmi 12,video to mp4 codec converter for android,how to converter 720p to mov on android,mov codec vlc android,video to mov converter for android,how to convert mov into h264 on android,mov converter android 2018
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Will Xiaomi Redmi 12 support QuickTime .mov files? If you are having issues playing MOV files on Xiaomi Redmi 12, you are just here in the right place. This article explains how to get Xiaomi Redmi 12 playing MOV movies through the way of converting MOV files to MP4 format.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “Hi guys, I just changed for the Xiaomi Redmi 12 about half a month ago and I'm very pleased with it and don't regret leaving Apple, saving for iTunes compatibility. Anyways can anyone please tell me if there's a way I could play my .mov videos taken with my old iPhone on my Xiaomi Redmi 12? Thanks.”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  Since Xiaomi Redmi 12 does not support playback of .MOV files using its stock player, you will need to install a third party media player that supports QuickTime MOV, or process file conversion before the playback. To download a .mov player for your Xiaomi Redmi 12, you can give VLC player, MX Player, BS Player and Mobo player a shot. To convert MOV files for viewing on Xiaomi Redmi 12, you can give Video Converter a shot. You load your MOV files to this Converter app, and choose H.264 MP4 as output format. This will ensure the converted files have a good playback performance on your Xiaomi Redmi 12.
</p>
</div>
</div>

Part 1: <strong><a href="#p1">You can convert .mov files for Xiaomi Redmi 12 (on Windows)</a></strong>
Part 2: <strong><a href="#p2">You can convert .mov files for Xiaomi Redmi 12 (on macOS)</a></strong>

<!-- Part 1 -->
<a id="p1" name="p1" ></a><hr>

<div class="atpl-step-part-style">Part 1. You can convert .mov files for Xiaomi Redmi 12 (on Windows)</div>
To convert .mov video files for Xiaomi Redmi 12 playback on Windows, do as below:
...
<div class="atpl-step-part-style">Part 2. You can convert .mov files for Xiaomi Redmi 12 (on macOS)</div>
To convert .mov video files for Xiaomi Redmi 12 playback on Mac, do as below:
