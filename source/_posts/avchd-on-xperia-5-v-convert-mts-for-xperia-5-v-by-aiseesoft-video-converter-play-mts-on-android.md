...
categories: 
  ...
  - aiseesoft
  - video converter
description: Surprised to find that your Sony Xperia 5 V does not come with native support for AVCHD .MTS format used in many video cameras? The problem can be solved by  converting AVCHD files to MP4 format. 
keywords: avchd player for Sony Xperia 5 V,avchd player for Sony ,encode avchd to mp4 for Sony ,play mts clips on Sony ,play mts clips on Xperia 5 V,watch avchd on Xperia 5 V,video to mts codec converter for android,how to converter 720p to mts on android,mts file not supported in Sony Xperia 5 V,Sony Xperia 5 V wont play mts,mts codec vlc android,mts converter for android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Wanna watch MTS clips copied from your AVCHD camera on Sony Xperia 5 V? AVCHD is a popular file-based format for digital recording and playback of high-definition video. Most Android phones or tablets lack native support for AVCHD MTS footage. You can either use a third party media player like VLC or MX player to play MTS files on your Sony Xperia 5 V, or convert AVCHD footage to MP4 format that is well compatible with Sony Xperia 5 V.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-content">
  <p>
    Cannot view AVCHD MTS files on your Sony Xperia 5 V flawlessly? The stock media player may refuse recognizing .mts file extension because Sony Xperia 5 V doesn’t have native support for AVCHD mts video clips. However, you could always use an app like Video Converter to convert your AVCHD .mts files to .mp4 format on your computer and then move them to your Sony Xperia 5 V for playback fluently without any incompatibility issues. In the guide below, we walk you through how to encode AVCHD MTS files to MP4 format for viewing on Sony Xperia 5 V smoothly.
  </p>
</div>
</div>

Part 1: <strong><a href="#p1">AVCHD MTS Conversion Suggestion For Sony Xperia 5 V (on Windows)</a></strong>
Part 2: <strong><a href="#p2">AVCHD MTS Conversion Suggestion For Sony Xperia 5 V (on macOS)</a></strong>

<!-- Part 1 -->
<a id="p1" name="p1" ></a><hr>

<div class="atpl-step-part-style">Part 1. AVCHD MTS Conversion Suggestion For Sony Xperia 5 V (on Windows)</div>
To convert .mts video files for Sony Xperia 5 V playback on Windows, do as below:
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/sony/fv.mp4/win/profile-4.png" class="atpl-imgstyle" alt="Select output profile format for Sony Xperia 5 V" />
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/sony/fv.mp4/win/settings.png" class="atpl-imgstyle"  alt="Update Profile settings for Sony Xperia 5 V" />
...
<div class="atpl-step-part-style">Part 2. AVCHD MTS Conversion Suggestion For Sony Xperia 5 V (on macOS)</div>
To convert .mts video files for Sony Xperia 5 V playback on Mac, do as below:
