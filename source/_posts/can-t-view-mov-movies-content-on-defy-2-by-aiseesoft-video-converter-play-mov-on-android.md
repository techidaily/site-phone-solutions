...
keywords: can't open .mov on Motorola Defy 2,Motorola mov support,convert mov files for Motorola Defy 2,can't open .mov on Defy 2,watch .mov on Defy 2,convert mov files for Defy 2,video to mp4 codec converter for android,mov to h264 converter android,best mov transcoder android,mov to mp4 video converter for android,how to converter 720p to mov on android,mov codec vlc android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    If you are trying to play QuickTime .mov files on Motorola Defy 2, you may encounter issues one or another. That’s because .mov files don't play well on most Android devices. However, this problem can be solved via converting MOV files to Motorola Defy 2 supported MP4 format. 
  </p>
</div>
</div>
