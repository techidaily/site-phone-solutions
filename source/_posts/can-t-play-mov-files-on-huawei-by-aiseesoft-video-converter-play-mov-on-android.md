...
keywords: .mov playback on Huawei ,will mov play on Nova Y71,can't open .mov on Nova Y71,.mov playback on Huawei Nova Y71,mov to Huawei  converter,best app to play .mov on Huawei ,Huawei Nova Y71 wont play mov,mov file not supported in Huawei Nova Y71,how to converter 720p to mov on android,mov to h264 converter android,mov codec vlc android,playing mov videos on phone android
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Will Huawei Nova Y71 support QuickTime .mov files? If you are having issues playing MOV files on Huawei Nova Y71, you are just here in the right place. This article explains how to get Huawei Nova Y71 playing MOV movies through the way of converting MOV files to MP4 format.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  MOV video file fails to open on Huawei Nova Y71 
</div>
<div class="tpl-content-sub-paragraph-content">
  <p>
    “My MOV video file fails to open on Huawei Nova Y71 . Tried to play it through RockPlayer, MoboPlayer, and VLC, but .mov video simply doesn’t play. I receive a black screen every time I double-click my .mov file. What should I do?”
  </p>
  <p>
    MOV is a container format. If your MOV file holds a video or audio codec that Huawei Nova Y71 doesn’t support, you will probably fail to play the MOV file. In that case, you will need to convert it first. That’s where an MOV to Huawei Nova Y71  converter comes in. Check a simple guide on how to re-encode MOV files to H.264 MP4 for viewing on Huawei Nova Y71  smoothly. 
  </p>
</div>
</div>
