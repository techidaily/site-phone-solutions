---
title: Does Sony Xperia 1 V support MOV videos ?
date: 2024-04-07T02:22:07.827Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: Will Sony Xperia 1 V support .mov files? If you are having issues playing MOV files on Sony Xperia 1 V, you are just here in the right place. This article explains how to get Sony Xperia 1 V playing MOV movies in simple steps.
keywords: watch .mov on Sony Xperia 1 V,can't open .mov on Sony Xperia 1 V,watch .mov on Sony ,play .mov on Xperia 1 V,.mov playback on Sony Xperia 1 V,can't open .mov on Xperia 1 V,mov to mp4 video converter for android,Sony Xperia 1 V wont play mov,tv Sony mov 265,mov codec vlc android,how to convert mov into h264 on android,mov video converter for android
---
...
<div class="tpl-content-sub-paragraph-question">
  MOV video file fails to open on Sony Xperia 1 V 
</div>
<div class="tpl-content-sub-paragraph-content">
  <p>
    “My MOV video file fails to open on Sony Xperia 1 V . Tried to play it through RockPlayer, MoboPlayer, and VLC, but .mov video simply doesn’t play. I receive a black screen every time I double-click my .mov file. What should I do?”
  </p>
  <p>
    MOV is a container format. If your MOV file holds a video or audio codec that Sony Xperia 1 V doesn’t support, you will probably fail to play the MOV file. In that case, you will need to convert it first. That’s where an MOV to Sony Xperia 1 V  converter comes in. Check a simple guide on how to re-encode MOV files to H.264 MP4 for viewing on Sony Xperia 1 V  smoothly. 
  </p>
</div>
</div>
