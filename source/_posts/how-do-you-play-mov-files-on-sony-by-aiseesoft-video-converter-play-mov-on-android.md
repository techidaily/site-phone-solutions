---
title: How do you play .mov files on Sony  ?
date: 2024-05-19T17:46:52.728Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: This article helps those who are having problems watching MOV video files on Sony Xperia 5 V. It guides you through the process of converting .mov files to H.264 MP4 for viewing on Sony Xperia 5 V flawlessly. 
keywords: convert mov files for Sony Xperia 5 V,does mov play on Xperia 5 V,will mov play on Xperia 5 V,will mov play on Sony Xperia 5 V,play .mov on Sony ,convert mov files for Xperia 5 V,mov codec vlc android,how to convert mov into h264 on android,mov to mp4 video converter for android,video to mp4 codec converter for android,mov file not supported in Sony Xperia 5 V,Sony Xperia 5 V wont play mov
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    Will Sony Xperia 5 V support QuickTime .mov files? If you are having issues playing MOV files on Sony Xperia 5 V, you are just here in the right place. This article explains how to get Sony Xperia 5 V playing MOV movies through the way of converting MOV files to MP4 format.
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “Hi guys, I just changed for the Sony Xperia 5 V about half a month ago and I'm very pleased with it and don't regret leaving Apple, saving for iTunes compatibility. Anyways can anyone please tell me if there's a way I could play my .mov videos taken with my old iPhone on my Sony Xperia 5 V? Thanks.”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  Since Sony Xperia 5 V does not support playback of .MOV files using its stock player, you will need to install a third party media player that supports QuickTime MOV, or process file conversion before the playback. To download a .mov player for your Sony Xperia 5 V, you can give VLC player, MX Player, BS Player and Mobo player a shot. To convert MOV files for viewing on Sony Xperia 5 V, you can give Video Converter a shot. You load your MOV files to this Converter app, and choose H.264 MP4 as output format. This will ensure the converted files have a good playback performance on your Sony Xperia 5 V.
</p>
</div>
</div>
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/sony/fv.mp4/win/profile-2.png" class="atpl-imgstyle" alt="Select output profile format for Sony Xperia 5 V" />
