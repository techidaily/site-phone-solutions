---
title: Does Motorola Edge 40 support MOV videos ?
date: 2024-04-30T19:42:12.350Z
tags: 
  - mov video
  - mov android
categories: 
  ...
  - aiseesoft
  - video converter
description: Can't open MOV files on Motorola Edge 40? All you need is a .MOV to Motorola Edge 40 converter. Keep reading to learn a guide on how to encode MOV files for playback on Motorola Edge 40 fluently. 
keywords: does mov play on Edge 40,can't open .mov on Edge 40,can't play .mov on Edge 40,.mov playback on Edge 40,mov to Motorola Edge 40 converter,convert mov files for Motorola ,mov converter android 2018,video to mp4 codec converter for android,tv Motorola mov 265,Motorola Edge 40 wont play mov,mov video converter for android,mov file not supported in Motorola Edge 40
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    If you are trying to play QuickTime .mov files on Motorola Edge 40, you may encounter issues one or another. That’s because .mov files don't play well on most Android devices. However, this problem can be solved via converting MOV files to Motorola Edge 40 supported MP4 format. 
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “Hi guys, I just changed for the Motorola Edge 40 about half a month ago and I'm very pleased with it and don't regret leaving Apple, saving for iTunes compatibility. Anyways can anyone please tell me if there's a way I could play my .mov videos taken with my old iPhone on my Motorola Edge 40? Thanks.”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  Since Motorola Edge 40 does not support playback of .MOV files using its stock player, you will need to install a third party media player that supports QuickTime MOV, or process file conversion before the playback. To download a .mov player for your Motorola Edge 40, you can give VLC player, MX Player, BS Player and Mobo player a shot. To convert MOV files for viewing on Motorola Edge 40, you can give Video Converter a shot. You load your MOV files to this Converter app, and choose H.264 MP4 as output format. This will ensure the converted files have a good playback performance on your Motorola Edge 40.
</p>
</div>
</div>

Part 1: <strong><a href="#p1">You can convert .mov files for Motorola Edge 40 (on Windows)</a></strong>
Part 2: <strong><a href="#p2">You can convert .mov files for Motorola Edge 40 (on macOS)</a></strong>

<!-- Part 1 -->
<a id="p1" name="p1" ></a><hr>

<div class="atpl-step-part-style">Part 1. You can convert .mov files for Motorola Edge 40 (on Windows)</div>
To convert .mov video files for Motorola Edge 40 playback on Windows, do as below:
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/moto/fv.mp4/win/profile-4.png" class="atpl-imgstyle" alt="Select output profile format for Motorola Edge 40" />
...
<img src="https://tools.techidaily.com/images/apps/aiseesoft/video-converter/devices/moto/fv.mp4/win/settings.png" class="atpl-imgstyle"  alt="Update Profile settings for Motorola Edge 40" />
...
<div class="atpl-step-part-style">Part 2. You can convert .mov files for Motorola Edge 40 (on macOS)</div>
To convert .mov video files for Motorola Edge 40 playback on Mac, do as below:
