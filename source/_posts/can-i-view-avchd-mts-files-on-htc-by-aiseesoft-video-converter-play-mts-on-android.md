...
keywords: play mts clips on U23,play avchd files on HTC ,watch avchd on HTC U23,convert avchd mts for HTC ,mts converter for HTC ,mts playback on HTC ,playing mts videos on phone android,video to mts codec converter for android,mts file not supported in HTC U23,best mts transcoder android,mts converter android 2018,mts converter for android
---
...
<p>
  AVCHD is a form of video compression that allows the large data files created by HD video recording to be captured and saved on digital media such as hard disk drives and flash memory cards. It usually comes with .mts file extension. If you would like to play AVCHD .mts files on your HTC U23, but failed for some reason, we would recommend converting the AVCHD media to a format that is well supported by HTC U23 first, such as H.264 codec encoded MP4 format, which HTC U23 will open and play well. Here’s a quick guide displaying how to process AVCHD to MP4 conversion for HTC U23. 
</p>
</div>
</div>
