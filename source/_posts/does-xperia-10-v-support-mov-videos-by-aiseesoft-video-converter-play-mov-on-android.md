...
categories: 
  ...
  - aiseesoft
  - video converter
description: How can I play .mov files on my Sony Xperia 10 V? If you are in a trouble to watch MOV videos on Sony Xperia 10 V, you may wish to read this guide. It explains how to convert MOV files to MP4 format for playing on Sony Xperia 10 V smoothly. 
keywords: watch .mov on Xperia 10 V,can't open .mov on Sony Xperia 10 V,mov to Sony  converter,Sony Xperia 10 V mov support,does mov play on Xperia 10 V,mov codec vlc android,Sony Xperia 10 V wont play mov,how to convert mov into h264 on android,mov converter android 2018,mov to mp4 video converter for android,mov to h264 converter android
---
...
<div class="tpl-content-sub-paragraph-question">
  MOV video file fails to open on Sony Xperia 10 V 
</div>
<div class="tpl-content-sub-paragraph-content">
  <p>
    “My MOV video file fails to open on Sony Xperia 10 V . Tried to play it through RockPlayer, MoboPlayer, and VLC, but .mov video simply doesn’t play. I receive a black screen every time I double-click my .mov file. What should I do?”
  </p>
  <p>
    MOV is a container format. If your MOV file holds a video or audio codec that Sony Xperia 10 V doesn’t support, you will probably fail to play the MOV file. In that case, you will need to convert it first. That’s where an MOV to Sony Xperia 10 V  converter comes in. Check a simple guide on how to re-encode MOV files to H.264 MP4 for viewing on Sony Xperia 10 V  smoothly. 
  </p>
</div>
</div>
