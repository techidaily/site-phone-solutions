...
categories: 
  ...
  - aiseesoft
  - video converter
description: What to do if your Huawei Nova Y71 cannot play AVCHD .mts video clips? If you fail or have problems playing AVCHD MTS files on your Huawei Nova Y71, you can follow our solution to solve the issue.
keywords: play avchd files on Huawei ,avchd to Nova Y71 converter,play avchd files on Nova Y71,play mts clips on Huawei Nova Y71,view mts files on Nova Y71,mts playback on Nova Y71,mts video converter for android,mts codec vlc android,playing mts videos on phone android,how to converter 720p to mts on android,best mts transcoder android,Huawei Nova Y71 wont play mts
---
...
<div class="tpl-content-sub-paragraph-normal">
  <p>
    What to do if your Huawei Nova Y71 cannot play AVCHD .mts video clips? Depending on your device model, source media parameters, as well as the media player you are using, you may fail or have problems playing AVCHD MTS files on your Huawei Nova Y71. In this article, we explain a solution to solve the issue. 
  </p>
</div>
</div>
...
<div class="tpl-content-sub-paragraph-question">
  “I'm trying to figure out what I'm going to do with AVCHD .mts files on my Huawei Nova Y71. They were taken with a Panasonic camera. I’d like to watch them on Huawei Nova Y71, but it refused to play them. So I'm stuck. Has anyone else figured out how to play the files in this .mts format on Huawei Nova Y71? Any suggestions?”
</div>
<div class="tpl-content-sub-paragraph-content">
<p>
  The native video player on your Huawei Nova Y71 will not support AVCHD files. However, you have two options to go through the issue. You can either install a third party video player (e.g. VLC player, MX player, MoboPlayer, etc.) or convert AVCHD .mts files to MP4 format via using a converter app. Check out a guide on how to re-encode AVCHD .mts files for playing on Huawei Nova Y71.
</p>
</div>
</div>
