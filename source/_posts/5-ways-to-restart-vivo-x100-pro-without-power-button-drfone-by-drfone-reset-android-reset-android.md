---
title: 5 Ways to Restart Vivo X100 Pro Without Power Button | Dr.fone
date: 2024-07-17T15:49:51.783Z
updated: 2024-07-18T15:49:51.783Z
tags: 
  - reset
categories:
  - android
description: This article describes 5 Ways to Restart Vivo X100 Pro Without Power Button
excerpt: This article describes 5 Ways to Restart Vivo X100 Pro Without Power Button
keywords: factory reset,Vivo X100 Pro soft reset,Vivo X100 Pro hard reset,soft reset,Vivo X100 Pro factory reset,hard reset
thumbnail: https://thmb.techidaily.com/0f399835ae801930fc09d856b55526ca68007b6aa28f7cfc8442056063114a14.jpg
---

## 5 Ways to Reset Vivo X100 Pro Without Volume Buttons
...
- Reset Android tablets or phones when the Vivo X100 Pro device is locked or without a volume button.
- Bypass the FRP lock of Vivo X100 Pro without a PIN or Google account.
- Support most mainstream Android models like Vivo X100 Pro, Vivo X100 Pro, Xiaomi, etc.
...
Dr.Fone will ask you to select your device brand and display the specific way to restart the Vivo X100 Pro device. You need to select your device brand in this step because the unlock way of different device brands is different. And then follow the instructions to restart your device.
...
<!-- affiliate ads end -->
## How to Reset a Vivo X100 Pro Phone That Is Locked

_“Looking for the best solutions on how to factory reset Vivo X100 Pro phone when locked?”_

The need to reset a Vivo X100 Pro phone arises in several situations like forgetting the password, PIN, or pattern, purchasing a second-hand device that is locked, accidentally changing the password or setting a wrong one, and others. In all these and other similar situations, you would need to reset your Vivo X100 Pro phone and this can be done using different methods and tools.
...
## Part 1: Things You Should Be Aware of Before Resetting Vivo X100 Pro Phones

Before you start resetting your Vivo X100 Pro device through any of the methods, there are certain important things that should be considered and taken care of. Check them out as below.

- First of all, ensure that your Vivo X100 Pro phone is charged so that the battery does not go off in between and stop the ongoing process.
- Ensure to clear the cache on your Vivo X100 Pro phone.
- If your Vivo X100 Pro phone is not locked, make sure to take the backup of the Vivo X100 Pro device to prevent accidental loss of data. If the Vivo X100 Pro device is locked, ensure that from next time you keep taking the backup on regular basis.

<!-- affiliate ads begin -->
<a href="https://godlikehost.sjv.io/c/5597632/1920047/21774" target="_top" id="1920047"><img src="//a.impactradius-go.com/display-ad/21774-1920047" border="0" alt="" width="300" height="250"/></a><img height="0" width="0" src="https://imp.pxf.io/i/5597632/1920047/21774" style="position:absolute;visibility:hidden;" border="0" />
<!-- affiliate ads end -->
## Part 2: How to Reset Vivo X100 Pro Phone When Locked?

Once you have fulfilled the above mention pre-requisites, next comes the process of device resetting. If your Vivo X100 Pro phone is locked, there are different methods that can help you reset your device and the popular ones can be checked as below.

<!-- affiliate ads begin -->
<a href="https://shop.copernic.com/order/checkout.php?PRODS=41033095&QTY=1&AFFILIATE=108875&CART=1"><img src="https://secure.2checkout.com/images/merchant/8d30aa96e72440759f74bd2306c1fa3d/Copernic-2023-Affiliate-728x90-Advanced-3YR.png" border="0"></a>
<!-- affiliate ads end -->
### Method 1: Reset Vivo X100 Pro using Google's Android Device Manager

The Android Device Manager which is also known as Find My Phone is an excellent feature that is majorly used for locating the lost or the stolen phone. This feature also allows the users to unlock and reset their devices. The Android Device Manager can only function if you know the Google ID and password that was used for device initialization. The feature can be used to erase the Vivo X100 Pro device data and reset it.

#### Steps to reset Vivo X100 Pro phone using Google Android Device Manager
...
- **Step 2.** The list of devices will appear on the screen, from which you need to choose the Vivo X100 Pro phone that you want to unlock and reset.
...
With the completion of the above steps, your Vivo X100 Pro phone will reset.

<!-- affiliate ads begin -->
<a href="https://sentrypc.7eer.net/c/5597632/398457/3022" target="_top" id="398457"><img src="//a.impactradius-go.com/display-ad/3022-398457" border="0" alt="www.sentrypc.com" width="980" height="120"/></a><img height="0" width="0" src="https://sentrypc.7eer.net/i/5597632/398457/3022" style="position:absolute;visibility:hidden;" border="0" />
<!-- affiliate ads end -->
### Method 2: Perform a Hard Reset on Vivo X100 Pro with Hardware Keys

Hard reset which is also termed factory reset is a feature that will reset all the Vivo X100 Pro device settings and bring them to the factory setting status. While you perform the hard reset, all the data of your phone as well as the installed apps will also be deleted.

#### Steps to hard reset Vivo X100 Pro Phone

- **Step 1.** Using the **Power button**, turn off your Vivo X100 Pro phone.
...
_**Note**: After the hard reset, Google Account Verification, FRP screen will appear where you need to enter the correct Google account or PIN that was previously synced with the Vivo X100 Pro device. If you know the Google credentials, it's great, but in case you have forgotten then no need to worry as there are [Vivo X100 Pro FRP bypass tools](https://drfone.wondershare.com/google-frp-unlock/huawei-frp-tools.html) available as well as Vivo X100 Pro codes that can be used to bypass the FRP lock._

### Method 3: An Efficient Alternative to Reset Locked Vivo X100 Pro Phone

If the above-listed methods do not work for any reason, we recommend using [Dr.Fone-Screen Unlock (Android)](https://tools.techidaily.com/wondershare-dr-fone-unlock-android-screen/) as the best alternative. This is a Windows and Mac-based tool that can help bypass and remove all types of screen locks including PIN, passcode, pattern, Face ID as well as a fingerprint. The software not only works with Vivo X100 Pro but all other popular Android devices including Vivo X100 Pro, LG, Oppo, and more.
...
The Best Tool for factory reset Vivo X100 Pro Phone When Locked

- Work perfectly to reset your Vivo X100 Pro without a password.
...
- Except for resetting, it also unlocks the locked Vivo X100 Pro if you are using a PIN, fingerprint, or other screen locks.

**4,464,992** people have downloaded it

#### Steps on how to factory reset Vivo X100 Pro phone without password using Dr. Fone - Screen Unlock
...
- **Step 2.** Next, your Vivo X100 Pro phone needs to be connected to the system using a USB cable, and then from the interface select **Unlock Android Screen** option.
...
- **Step 3.** In the next step, select your Vivo X100 Pro phone's brand from the supported list in Dr.Fone to ensure it enters the correct specific mode.
...
## Part 3. How to Reset Vivo X100 Pro Phone at Normal Cases?

In normal situations, the Vivo X100 Pro phones can be reset using the settings menu or the Android Factory Reset code. Both these methods and their guide to getting the process done are listed below.

### Method 1: Reset Vivo X100 Pro phones through the Phone Settings menu

To unlock the screen and reset your Vivo X100 Pro phone, the settings menu of the Vivo X100 Pro device can be used. For this method, you do not need to make your device enter the recovery mode. The steps for the process are as follows.

- **Step 1.** On your Vivo X100 Pro phone, open the Settings app and look for the **Backup and Reset** option from the **Personalization** section.
...
### Method 2: Reset Vivo X100 Pro phones with factory reset code

There are Android Reset Codes for different brands of phones that can be used for resetting the Vivo X100 Pro device. These secret codes can be different phones as well as OS versions. In general, the code used for resetting Vivo X100 Pro phones is **\*#\*#2846579#\*#\***.

Steps to reset Vivo X100 Pro phone using secret reset code

- **Step 1.** On your Vivo X100 Pro phone, go to the dialer and type the code- **\*#\*#2846579#\*#\***.
- **Step 2.** From the menu, click on the **Restore Factory** option.
- **Step 3.** Finally, to confirm the resetting of the Vivo X100 Pro device, click on the **OK** button.

The above methods can also be tried if you get stuck in a situation on how to factory reset Vivo X100 Pro tablets without password. Also, we recently covered a method of how to bypass the Google account on Vivo X100 Pro after a factory reset, we have now had the opportunity to test this with many people with different models of Android and have found mixed results.

## Conclusion

The above given are multiple options that can be used for resetting your Vivo X100 Pro phone when you forget your device unlock password. Some of these solutions can be used for free and if they work, nothing like that. [Dr.Fone – Screen Unlock (Android)](https://tools.techidaily.com/wondershare-dr-fone-unlock-android-screen/) is one of the best methods to reset your Vivo X100 Pro device as it supports removing all types of screen locks in a hassle-free manner.
...
<li><a href="https://discord-videos.techidaily.com/2024-approved-the-insiders-guide-to-clearer-communication-via-voicemod-on-discord/"><u>2024 Approved  The Insider's Guide to Clearer Communication via VoiceMod on Discord</u></a></li>
