---
title: Forgot your Honor 100 lock screen pattern, PIN or password? Here’s what to do
...
keyword: reset pattern lock,forgotten screen lock,remove fingerprint,remove Honor 100 lock screen,remove Honor 100 pattern,remove PIN,how to unlock android phone if i forget the password,forgotten my android phone's lock,remove android phone pattern,remove android fingerprint,remove android phone password,remove android lock screen
---
