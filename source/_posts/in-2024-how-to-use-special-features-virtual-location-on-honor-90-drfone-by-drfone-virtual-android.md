---
title: In 2024, How To Use Special Features - Virtual Location On Honor 90? | Dr.fone
date: 2024-07-17T18:07:12.039Z
updated: 2024-07-18T18:07:12.039Z
tags: 
...
categories:
  - android
description: This article describes How To Use Special Features - Virtual Location On Honor 90?
excerpt: This article describes How To Use Special Features - Virtual Location On Honor 90?
keywords: change location on android,fake location on android,fake gps location on android,change location on 90,fake location on 90,change gps location on android
...
## 8 Solutions to Fix 'Find My Friends Location Not Available' On Honor 90
...
**_Does "Location Not Available" mean that there is something wrong with Honor 90 ?_**
...
"No Location Found" means that the Find My app is unable to locate the Honor 90 device being tracked. This can happen for a variety of reasons, such as if the Honor 90 device is turned off, not connected to the internet, or if location services are disabled.

"Location Not Available" means that the Honor 90 device is not currently sharing its location with the Find My app. This can happen if the Honor 90 device is in Airplane mode or if the user has turned off location sharing for the Find My app. It can also happen if there is a temporary issue with the iCloud servers.

In summary, "No Location Found" means the app could not locate the Honor 90 device, while "Location Not Available" means that the Honor 90 device is not currently sharing its location.

## Part 2: Possible Reasons For Find My Friends Location Honor 90  Not Available
...
All these reasons can be the ones causing trouble on your Honor 90  and Android phones. Hence, you will have to look for some conventional methods to fix the unavailable location error.
...
### Tip 3: Adjust Honor 90  Date and Time
...
**Step 1:** For Honor 90  users: get to the "Settings" app and go to "Privacy & Security". You will find the "Location Services" feature, click on it, and see the "Share My Location" feature.
...
### Tip 6: Restart the Honor 90  or Android Phones

The next tip to use when Find My Friends says location not available is restarting your phone. For most devices, the method is common. But for Honor 90  X and 11, the steps are slightly different. For other Honor 90  models, press the Power button and wait until the slider appears. For Honor 90  X and 11/12/13/14, you'll have to hold the Volume button and the Power button together to make the slider appear on the screen.

![restart Honor 90](https://www.virtuallocation.com/images/pokemon-go/restart-Honor 90 .jpg)

Drag the Power slider to the right side and wait for the Honor 90 device to shut down. Wait for a minute before you restart the Honor 90 device, and hopefully, the feature will start working again as usual.
...
With Dr. Fone - Virtual Location software, you will be able to share [a fake or any location](https://drfone.wondershare.com/virtual-location/how-to-fake-location-on-find-my-friends.html) you want with your friends and family. Alongside this, Dr. Fone will also pace up your movement to ensure that your friends and family members won't find out that you share fake locations with them. The video below teaches you how to teleport your Honor 90  GPS location, and more tips and tricks can be found in the [Wondershare Video Community](https://www.wondershare.com/explore/inspiration.html).

**Here is a video for you to learn how to fix Honor 90  Find My Friends location not available:**
...
**Step 2:** The next step is to set up the phone's connection. Connect your Honor 90  and click on the "Get Started" button. Now, detect your current virtual location by clicking on the "Current Virtual Location" icon.
...
**Step 3:** Now go to the search box and type the location you want to switch to. Once the location gets detected, click on the "Move Here" option, and the location of your Honor 90  or Android phone will change to the one you specified.
...
<a href="https://shop.mondly.com/affiliate.php?ACCOUNT=ATISTUDI&AFFILIATE=108875&PATH=https%3A%2F%2Fwww.mondly.com%3FAFFILIATE%3D108875%26RESOURCE%3D%2BEducational%2B970x90%2B"><img src="https://secure.avangate.com/images/merchant/69c418c33ec2e1a4267fa9bb77fa1428/educational-970x90.gif" border="0"></a>
<!-- affiliate ads end -->
## FAQs You May Want to Know about Honor 90  Location

**1\. Is there a way to check if someone has stopped sharing their location with you on their Honor 90 ?**

If someone stops sharing their location with you on their Honor 90 , you will see "Location Not Available" next to their name in the Find My app or Messages app. You can check the status of location sharing by tapping their name in the Find My app.

**2\. Can I track a stolen Honor 90  if it is turned off?**

You may still be able to track a stolen Honor 90  if it is turned off using the Find My app or iCloud website. However, this depends on several factors, such as whether the Honor 90 device is connected to a Wi-Fi or cellular network, and whether the person who stole the Honor 90 device has turned off location services.

**3\. Can I track someone else's Honor 90  location without their permission?**

No, you cannot track someone else's Honor 90  location without their permission. The Find My app only allows you to track the location of devices that are signed in with your Apple ID, and you need the other person's permission to share their location with you.
...
Hopefully, now you know "why is find my friends not working" and several ways to fix the Find Friends location not available. In this guide, we learned all these tips to make it easy for Honor 90  users to rectify the issues with the Find Friends app. Check all the tips carefully and implement them whenever you face issues like this.
